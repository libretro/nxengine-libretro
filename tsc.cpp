...
static void crtoslashn(const char *in, char *out)
{
	int i, j;
...
static void NPCDo(int id2, int p1, int p2, void (*action_function)(Object *o, int p1, int p2))
{
...
static bool contains_non_cr(const char *str)
{
	for(int i = 0; str[i]; i++)
	{
		if (str[i] != '\r' && str[i] != '\n')
