...
void ai_polishbaby(Object *o)
{
	...
	{
		o->state = 1;
		if (!nx_random(0, 1)) o->xinertia = nx_random(0x100, 0x200);
				  else o->xinertia = nx_random(-0x200, -0x100);
		
		if (!nx_random(0, 1)) o->yinertia = nx_random(0x100, 0x200);
				  else o->yinertia = nx_random(-0x200, -0x100);
	}
...
void ai_crow(Object *o)
{
	...
	switch(o->state)
	{
		case 0:
		{
			...
			o->animframe = nx_random(0, 1);
			o->animtimer = nx_random(0, 4);
		}
		case 1:
		case 101:
		{
...
Object *skull;
	...
	skull->timer = nx_random(0, 50);
	o->linkedobject = skull;
	
	// switch over to the main crow AI, but only move up & down
	o->yinertia = nx_random(-0x200, -0x100);
	o->xmark = o->x;
	o->ymark = o->y + nx_random(-(28 << CSF), (10 << CSF));
	o->animframe = nx_random(0, 1);
	o->animtimer = nx_random(0, 4);
	o->state = 101;
	o->type = OBJ_CROW;
