...
COMMON_OBJS := $(NX_DIR)/common/BList.o $(NX_DIR)/common/bufio.o $(NX_DIR)/common/DBuffer.o $(NX_DIR)/common/DString.o $(NX_DIR)/common/FileBuffer.o $(NX_DIR)/common/InitList.o $(NX_DIR)/common/misc.o $(NX_DIR)/common/stat.o $(NX_DIR)/common/StringList.o
