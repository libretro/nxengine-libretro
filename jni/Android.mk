...
COMMON_OBJS := $(NX_DIR)/common/BList.cpp $(NX_DIR)/common/bufio.cpp $(NX_DIR)/common/mwrapper.cpp $(NX_DIR)/common/DBuffer.cpp $(NX_DIR)/common/DString.cpp $(NX_DIR)/common/FileBuffer.cpp $(NX_DIR)/common/InitList.cpp $(NX_DIR)/common/misc.cpp $(NX_DIR)/common/StringList.cpp
