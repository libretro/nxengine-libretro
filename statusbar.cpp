...
static void InitPercentBar(PercentBar *bar, int starting_value)
{
...
static void RunPercentBar(PercentBar *bar, int current_value)
{
...
static void DrawPercentBar(PercentBar *bar, int x, int y, int curvalue, int maxvalue, int width)
{
...
static void DrawAirLeft(int x, int y)
{
